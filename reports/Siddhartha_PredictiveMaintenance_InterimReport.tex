...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{figures/univariate_sensor_distributions.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{figures/bivariate_sensor_vs_target.png}
\caption{Sensor value comparison across normal and failure conditions}
\label{fig:bivariate}
\end{figure}
...
\begin{table}[H]
\centering
\caption{Comparison of baseline and final model performance on test data}
\label{tab:model_performance}
\begin{tabular}{lccc}
\toprule
Model & Recall & F1-score & ROC-AUC \\
\midrule
Decision Tree & 0.678441 & 0.675971 & 0.558750 \\
Random Forest & 0.900122 & 0.770059 & 0.699443 \\
\bottomrule
\end{tabular}
\end{table}
